...
df = pd.read_csv('Combined_5min_metrics.csv')                 #Mudar o ficheiro para dar plot
...
for i in range(6,12):       #6 a 12 para ir da columa 7-12 com os averages, ou range(6) para fazer as 6 primeiras colunas
